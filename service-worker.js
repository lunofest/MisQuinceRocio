const CACHE_NAME = 'cache-v106'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v106',
    'estilos/styles.css?v106',
    'estilos/mediaQueries.css?v106',
    'javascript/script.js?v106',
