...
function updateTimer() {
    const targetDate = new Date("March 15, 2025 21:30:00").getTime();
...
document.addEventListener("DOMContentLoaded", function() {
    var swiper = new Swiper(".mySwiper", {
        slidesPerView: 1, // Empieza mostrando una sola imagen
        spaceBetween: 30,
        pagination: {
    ...
    Fancybox.bind('[data-fancybox="gallery"]', {
        ...
        Toolbar: {
            display: ["zoom", "thumbs", "close"], // Botones a mostrar
        },
        loop: true,
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const recipientNumber1 = '543813552618'; // Número para el primer botón
    const recipientNumber2 = '543815616189'; // Número para el segundo botón
...
document.getElementById('musicForm').addEventListener('submit', function(event) {
    ...
    const telefono = '543813552618'; // Reemplaza esto con tu número de WhatsApp
